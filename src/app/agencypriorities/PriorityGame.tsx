...
import { STORE, cards, kb } from "./lib";
    ...
    return (
      <div className="mx-auto w-full max-w-2xl px-4 py-12 sm:py-16">
        ...
        <div className="mt-6 flex gap-2">
          <span className="rounded-full bg-gold px-4 py-1.5 text-sm text-ink">List</span>
          <Link
            href="/agencypriorities/matrix"
            className="rounded-full border border-cream/20 px-4 py-1.5 text-sm text-cream/70 transition hover:border-cream/50 hover:text-cream"
          >
            Matrix
          </Link>
        </div>
